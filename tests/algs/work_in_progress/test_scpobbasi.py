...
def test_scpobbasi(
    ...
    assert (L_diagonal_blocks.ctypes.data == \
        I_diagonal_blocks.ctypes.data) is overwrite
    assert (L_lower_diagonal_blocks.ctypes.data == \
        I_lower_diagonal_blocks.ctypes.data) is overwrite
    assert (L_arrow_bottom_blocks.ctypes.data == \
        I_arrow_bottom_blocks.ctypes.data) is overwrite
    assert (L_arrow_tip_block.ctypes.data == \
        I_arrow_tip_block.ctypes.data) is overwrite
