...
def scpobaf(
    ...
    n_offdiags = A_lower_diagonals.shape[1]
    ...
    for i in range(n_diagonals-1):
        ...
        L_lower_diagonals[i, :-1] -= L_i1i1[0, :].conj() @ L_i1i1[1:, :].T
